...
//    public String oauthDialog(@RequestParam("client_id") String id,
...
//    public String doLoging(@RequestParam("redirect_uri") String redirectUri,
//            @RequestParam("email") String email, HttpServletResponse response)
//            throws IOException {
//        this.email = email;
//
//        URI uri = URI.create(java.net.URLDecoder.decode(redirectUri, "UTF-8")
//                + "?code=" + this.code);
...
//        String cookie = callbackResponse.getFirstHeader("Set-Cookie")
//                .getValue();
...
//    public String accessToken(@RequestParam("client_id") String clientId,
//            @RequestParam("redirect_uri") String redirectUri,
